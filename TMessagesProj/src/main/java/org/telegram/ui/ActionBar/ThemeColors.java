...
public class ThemeColors {
    ...
    public static final int TELEGRAM_COLOR = 0xFF7B7FEF;        // -14509328
    public static final int TELEGRAM_COLOR_TEXT = 0xFF6B6FD6;   // -14054705
    ...
    public static int[] createDefaultColors() {
        ...
        defaultColors[key_dialogTextLink] = 0xff5D5FAE;
        defaultColors[key_dialogLinkSelection] = 0x3362a9e3;
        defaultColors[key_dialogTextBlue] = 0xff6B6FD6;
        defaultColors[key_dialogTextBlue2] = 0xff6B6FD6;
        defaultColors[key_dialogTextBlue4] = 0xff7B7FEF;
        defaultColors[key_dialogTextGray] = 0xff5D5FAE;
        ...
        defaultColors[key_dialogLineProgress] = 0xff5D5FAE;
        ...
        defaultColors[key_windowBackgroundChecked] = 0xff7B7FEF;
        defaultColors[key_windowBackgroundCheckText] = 0xffffffff;
        defaultColors[key_progressCircle] = 0xff7B7FEF;
        defaultColors[key_windowBackgroundWhiteGrayIcon] = 0xff1a1d21;
        defaultColors[key_windowBackgroundWhiteBlueText] = 0xff6B6FD6;
        defaultColors[key_windowBackgroundWhiteBlueText2] = 0xff6B6FD6;
        defaultColors[key_windowBackgroundWhiteBlueText3] = 0xff5D5FAE;
        defaultColors[key_windowBackgroundWhiteBlueText4] = 0xff7B7FEF;
        defaultColors[key_windowBackgroundWhiteBlueText5] = 0xff6B6FD6;
        defaultColors[key_windowBackgroundWhiteBlueText6] = 0xff6B6FD6;
        defaultColors[key_windowBackgroundWhiteBlueText7] = 0xff5D5FAE;
        defaultColors[key_windowBackgroundWhiteBlueButton] = 0xff6B6FD6;
        defaultColors[key_windowBackgroundWhiteBlueIcon] = 0xff7B7FEF;
        ...
        defaultColors[key_windowBackgroundWhiteLinkText] = 0xff5D5FAE;
        ...
        defaultColors[key_contextProgressOuter1] = 0xff7B7FEF;
        ...
        defaultColors[key_avatar_background2Cyan] = 0xff6B6FD6;
        defaultColors[key_avatar_backgroundBlue] = 0xff5CAFFA;
        defaultColors[key_avatar_background2Blue] = 0xff6B6FD6;
        ...
        defaultColors[key_avatar_nameInMessageBlue] = 0xff6B6FD6;
        ...
        defaultColors[key_chats_tabUnreadActiveBackground] = 0xFF7B7FEF; //TELEGRAM_COLOR_TEXT;
        ...
        defaultColors[key_chats_sentCheck] = 0xff5D5FAE;
        defaultColors[key_chats_sentReadCheck] = 0xff5D5FAE;
        defaultColors[key_chats_sentClock] = 0xff6B6FD6;
        defaultColors[key_chats_sentError] = 0xffd55252;
        defaultColors[key_chats_sentErrorIcon] = 0xffffffff;
        defaultColors[key_chats_verifiedBackground] = 0xff7B7FEF;
        ...
        defaultColors[key_chats_menuItemCheck] = 0xff5D5FAE;
        ...
        defaultColors[key_chats_actionBackground] = 0xff7B7FEF;
        defaultColors[key_chats_actionPressedBackground] = 0xff6B6FD6;
        defaultColors[key_chats_menuTopBackgroundCats] = 0xff5D5FAE;
        ...
        defaultColors[key_chat_attachActiveTab] = 0xff7B7FEF;
        ...
        defaultColors[key_chat_attachGalleryBackground] = 0xff7B7FEF;
        ...
        defaultColors[key_chat_messageLinkIn] = 0xff5D5FAE;
        defaultColors[key_chat_messageLinkOut] = 0xff5D5FAE;
        ...
        defaultColors[key_chat_outSentClock] = 0xff6B6FD6;
        defaultColors[key_chat_outSentClockSelected] = 0xff6B6FD6;
        ...
        defaultColors[key_chat_inInstantSelected] = 0xff5D5FAE;
        ...
        defaultColors[key_chat_inForwardedNameText] = 0xff6B6FD6;
        ...
        defaultColors[key_chat_inReplyLine] = 0xff6B6FD6;
        ...
        defaultColors[key_chat_inPreviewLine] = 0xff7B7FEF;
        ...
        defaultColors[key_chat_inContactNameText] = 0xff6B6FD6;
        ...
        defaultColors[key_chat_inAudioTitleText] = 0xff6B6FD6;
        ...
        defaultColors[key_chat_emojiPanelStickerPackSelectorLine] = 0xff7B7FEF;
        ...
        defaultColors[key_chat_emojiPanelStickerSetNameHighlight] = 0xff6B6FD6;
        ...
        defaultColors[key_chat_unreadMessagesStartText] = 0xff6B6FD6;
        ...
        defaultColors[key_chat_replyPanelIcons] = 0xff7B7FEF;
        ...
        defaultColors[key_chat_messagePanelCursor] = 0xff7B7FEF;
        ...
        defaultColors[key_chat_recordedVoiceBackground] = 0xff7B7FEF;
        defaultColors[key_chat_recordedVoiceDarkerBackground] = 0xff5B5FAF;
        defaultColors[key_chat_recordedVoiceProgress] = 0xffD7D8FF;
        defaultColors[key_chat_recordedVoiceProgressInner] = 0xffffffff;
        defaultColors[key_chat_recordVoiceCancel] = 0xff6B6FD6;
        ...
        defaultColors[key_chat_emojiPanelNewTrending] = 0xff7B7FEF;
        ...
        defaultColors[key_profile_creatorIcon] = 0xff6B6FD6;
        ...
        defaultColors[key_profile_tabSelectedText] = 0xff6B6FD6;
        ...
        defaultColors[key_player_progress] = 0xff7B7FEF;
        defaultColors[key_player_button] = 0xff333333;
        defaultColors[key_player_buttonActive] = 0xff7B7FEF;
        ...
        defaultColors[key_passport_authorizeBackground] = 0xff7B7FEF;
        defaultColors[key_passport_authorizeBackgroundSelected] = 0xff6B6FD6;
        defaultColors[key_passport_authorizeText] = 0xffffffff;

        defaultColors[key_location_sendLocationBackground] = 0xff7B7FEF;
        defaultColors[key_location_sendLocationIcon] = 0xffffffff;
        defaultColors[key_location_sendLocationText] = 0xff6B6FD6;
        ...
        defaultColors[key_location_liveLocationProgress] = 0xff7B7FEF;
        defaultColors[key_location_placeLocationBackground] = 0xff7B7FEF;
        defaultColors[key_location_actionIcon] = 0xff3a4045;
        defaultColors[key_location_actionActiveIcon] = 0xff6B6FD6;
        defaultColors[key_location_actionBackground] = 0xffffffff;
        defaultColors[key_location_actionPressedBackground] = 0xfff2f2f2;

        defaultColors[key_dialog_liveLocationProgress] = 0xff7B7FEF;
        ...
        defaultColors[key_featuredStickers_addButtonPressed] = 0xff5B5FAF;
        defaultColors[key_featuredStickers_removeButtonText] = 0xff6B6FD6;
        defaultColors[key_featuredStickers_buttonText] = 0xffffffff;
        defaultColors[key_featuredStickers_unread] = 0xff7B7FEF;
        ...
        defaultColors[key_sharedMedia_startStopLoadIcon] = 0xff7B7FEF;
        ...
        defaultColors[key_login_progressOuter] = 0xff7B7FEF;

        defaultColors[key_picker_enabledButton] = 0xff7B7FEF;
        defaultColors[key_picker_disabledButton] = 0xff999999;
        defaultColors[key_picker_badge] = 0xff7B7FEF;
        defaultColors[key_picker_badgeText] = 0xffffffff;

        defaultColors[key_chat_botSwitchToInlineText] = 0xff6B6FD6;

        defaultColors[key_undo_background] = 0xea272f38;
        defaultColors[key_undo_cancelColor] = 0xffD7D8FF;
        ...
        defaultColors[key_chat_TextSelectionCursor] = 0xFF7B7FEF;
        defaultColors[key_chat_outTextSelectionCursor] = 0xFF7B7FEF;
        ...
        defaultColors[key_chat_editMediaButton] = 0xff7B7FEF;
        ...
        defaultColors[key_statisticChartBackZoomColor] = 0xff6B6FD6;
        defaultColors[key_statisticChartChevronColor] = 0xffD2D5D7;

        defaultColors[key_statisticChartLine_blue] = 0xff7B7FEF;
        ...
        defaultColors[key_statisticChartLine_lightblue] = 0xff7B7FEF;
        ...
        defaultColors[key_voipgroup_connectingProgress] = 0xff7B7FEF;
        ...
        defaultColors[key_voipgroup_unmuteButton] = 0xff7B7FEF;
        defaultColors[key_voipgroup_unmuteButton2] = 0xff7B7FEF;
        ...
        defaultColors[key_voipgroup_listeningText] = 0xff7B7FEF;
        ...
        defaultColors[key_voipgroup_topPanelBlue1] = 0xff7B7FEF;
        defaultColors[key_voipgroup_topPanelBlue2] = 0xff6B6FD6;
        ...
        defaultColors[key_voipgroup_mutedByAdminGradient] = 0xff7B7FEF;
        ...
        defaultColors[key_voipgroup_mutedByAdminMuteButton] = 0x7F7B7FEF;
        defaultColors[key_voipgroup_mutedByAdminMuteButtonDisabled] = 0x337B7FEF;
        ...
        defaultColors[key_premiumGradient0] = 0xff7B7FEF;
        defaultColors[key_premiumGradient1] = 0xff7B7FEF;
        ...
        defaultColors[key_premiumGradientBackground1] = 0xff7B7FEF;
        ...
        defaultColors[key_premiumGradientBottomSheet1] = 0xff7B7FEF;
        ...
        defaultColors[key_stories_circle1] = 0xFF7B7FEF; // 0xFF39DF3C;
        defaultColors[key_stories_circle2] = 0xFF2fc183; // 0xFF7B7FEF;
        defaultColors[key_stories_circle_dialog1] = 0xFF7B7FEF; // 0xFF4AED55;
        ...
        defaultColors[key_code_operator] = 0xFF7B7FEF;
        ...
        defaultColors[key_glass_tabSelected] = 0xFF7B7FEF;
        defaultColors[key_glass_tabSelectedText] = 0xFF6B6FD6;
        ...
        defaultColors[key_telegram_color_dialogsLogo] = 0xFF6B6FD6;
