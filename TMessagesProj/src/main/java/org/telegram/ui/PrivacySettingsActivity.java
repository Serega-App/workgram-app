...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void updateRows(boolean notify) {
        ...
        callsRow = rowCount++;
        groupsDetailRow = -1;
        // Workgram: hide Premium/Stars privacy rows before release
        voicesRow = -1;
        noncontactsRow = -1;
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == webSessionsRow) {
                        ...
                        textCell.setTextAndValue(getString(R.string.PrivacyVoiceMessages), value, noncontactsRow != -1);
                        ...
                        textCell.setTextAndValue(getString(R.string.PrivacyMessages), value, musicRow != -1);
                    } else if (position == passportRow) {
                ...
                case 1:
                    ...
                    if (position == deleteAccountDetailRow) {
                        privacyCell.setText("Если Вы не будете заходить в приложение за это время, аккаунт будет удалён вместе со всеми сообщениями и контактами.");
                        ...
                        privacyCell.setText("Предпросмотр для ссылок создаётся на серверах приложения. Мы не храним данные об отправленных вами ссылках.");
